...
public class Organization implements Comparable<Organization>, Serializable {
     ...
     * @param postalAddress
     */
    public Organization(Long id, String name, Coordinates coordinates, LocalDateTime creationDate, Double annualTurnover, String fullName, long employeesCount, OrganizationType type, Address postalAddress){
        this.id = id;
        this.name = name;
